...
def render_poetry(
    ...
    # Poetry lines - centered, each line on its own row
    max_lines = 8
    ...
    # Note at bottom if space allows
    ...
    draw_footer(draw, img, "POETRY", f"\u2014 {author}", dashed=True)
